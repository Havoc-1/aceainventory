...
urlpatterns = [
    ...
    path('deliveries/quotation/<int:pk>/edit', views.edit_quotation, name='edit_quotation'),
    path('deliveries/quotation/<int:pk>/delete', views.delete_quotation, name='delete_quotation'),
    path('deliveries/quotation/<int:pk>/details', views.quotation_details, name='quotation_details'),
