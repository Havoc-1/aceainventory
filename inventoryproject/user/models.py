...
class UserProfile(models.Model):
    user = models.OneToOneField(User, null=True, on_delete=models.CASCADE) #associating user model to django users, existing users present so has to be true , #CASCADE - deleting user will delete other stuff automatically
